...
const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://mandakinipublicschool.edu.in";
...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${baseUrl}/student-corner`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.7 },
